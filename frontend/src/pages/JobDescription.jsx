  ...
  return (
    <div className="max-w-5xl  mx-auto my-10">
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">Description: <span className="pl-4 font-normal text-gray-800">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod minima ex voluptates id nostrum delectus at maiores ipsam eligendi? Quos!</span> </h1>
